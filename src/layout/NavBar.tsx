  ...
  return (
    <>
      <nav
        ...
        <div className='items-center gap-x-14 px-2 py-1 mx-auto md:flex'>
          <div className='flex items-center justify-between md:block'>
            <a href='/'>
              <img
                src='https://cs-drive.com/wp-content/uploads/2023/08/CS-Drive-Full.png'
                width={180}
                height={50}
                alt='Float UI logo'
              />
            ...
            <ul className='items-center space-y-0 md:flex'>
                ...
                return (
                  <li key={index}>
                    <button
                      ...
                      onClick={() =>
                        setActiveMenuItem(
                          activeMenuItem !== index ? index : false
                        )
                      }>
                      {item.title}
              ...
              <div className='flex-1 items-center justify-end gap-x-6 space-y-3 md:flex md:space-y-0'>
                <li>
                  <a
                    href='/'
                    className='block py-2 px-3 font-medium text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow md:inline'>
                    Jobs
                  </a>
                </li>
              </div>
